create table student(rollno number(5) primary key, name varchar(20), age number(2), bname varchar(5), perc number(5));
...
update student set gmail='charan9@gmail.com' where rollno=420;
select *
from student
